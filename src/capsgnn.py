...
from src.utils import create_numeric_mapping
from src.layers import ListModule, PrimaryCapsuleLayer, Attention, SecondaryCapsuleLayer, margin_loss
...
class CapsGNN(torch.nn.Module):
    ...
    def calculate_reconstruction_loss(self, capsule_input, features):
        ...
        :return reconstruction_loss: Loss of reconstruction.
        """
...
class CapsGNNTrainer(object):
    ...
    def create_features(self, data):
        ...
        feature_indices = [self.feature_map[str(label)] for label in data["labels"].values()]
        ...
        for epoch in tqdm(range(self.args.epochs), desc="Epochs: ", leave=True):
            ...
            for step in self.steps:
                ...
                for path in batch:
                    ...
                    loss = margin_loss(prediction, data["target"],
                                       self.args.lambd) + self.args.theta * reconstruction_loss
